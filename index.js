...
var DelayHorizontalScroller = function () {
  ...
  _createClass(DelayHorizontalScroller, [{
    ...
    value: function _setItemPosition() {
      ...
      Array.prototype.forEach.call(this.elements.itens, function (block) {
        block.style.display = "inline-block";
        _this.elements.container.replaceChild(_this.elements.roller, block);
        _this.elements.roller.appendChild(block);
      });
...
var Lethargy = __webpack_require__(5).Lethargy;
